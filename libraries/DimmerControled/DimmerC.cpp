...
DimmerC::DimmerC(int ledPin, int buttonPin, int minVal, int maxVal, unsigned long dimTemp,  unsigned long dimDelay, int num) {
...
void DimmerC::ReadSerial(String comand) {
