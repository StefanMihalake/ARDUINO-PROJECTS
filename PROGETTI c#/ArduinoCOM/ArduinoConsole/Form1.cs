...
namespace ArduinoConsole
{
    public partial class Form1 : Form
    {
        ...
        //                if (response.Length < 15 && response.Length > 0)                    // response not empty
        //                {
        //                    switch (response[1])
        //                    {
        //                        case 4:
        //                            EnableCommand();
        //                            if (response[8] > 0)                                          // if the brightness is > than 0
        //                            {
        //                                onButton.BackColor = Color.DarkSeaGreen;
        //                                offButton.BackColor = Color.Silver;
        //                                int value = (int)Math.Round((decimal)(response[8]) * 100 / 255);
        //                                progressbar.Value = value;
        //                                dimLed.Visible = true;
        //                                dimLed.Text = value.ToString();
        //                            }
        //                            if (response[8] == 0)               // if the brightness is = 0
        //                            {
        ...
        //                                dimLed.Text = "OFF";
        //                            }
        //                            if (response[4] == 0)                // if min brightnes is default
        //                            {
        ...
        //                            else
        //                            {
        //                                int min = (int)Math.Round((decimal)(response[4]) * 100 / 255);
        //                                minValueLabel.Text = min.ToString() + "%";
        //                                minUserLabel.Text = min.ToString() + "%";
        //                                dimtrack.Minimum = min;
        //                            }
        //                            if (response[6] == 0)                 // if max brightnes is default
        //                            {
        ...
        //                            else
        //                            {
        //                                int max = (int)Math.Round((decimal)(response[6]) * 100 / 255);
